        ...
        <SafeAreaView className="flex-1 bg-white">
            ...
            >
                ...
                <View className="flex-1 px-5">
                    <View className="flex-1 p-6 border border-gray-300 rounded-xl bg-white mb-4">
                        <FlatList
                            data={fields}
                ...
                <View className="px-5 pb-5">
                    <TouchableOpacity
                        className="w-full bg-green-400 p-5 rounded-2xl border items-center"
                        onPress={handleNext}
                    >
